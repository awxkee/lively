...
//  Lively
//
//  Created by Radzivon Bartoshyk on 15/4/21.
...
/**
 ...
 Sample Code:
    ...
    LVSpriteSheetImage *sprite;
    sprite = [[LVSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    LVAnimatedImageView *imgView = [LVAnimatedImageView new];
