...
//  Lively
//
//  Created by Radzivon Bartoshyk on 14/12/9.
...
/**
 ...
 The animation can be played by LVAnimatedImageView.
 
 Sample Code:
     
     NSArray *paths = @[@"/ani/frame1.png", @"/ani/frame2.png", @"/ani/frame3.png"];
     NSArray *times = @[@0.1, @0.2, @0.1];
     LVFrameImage *image = [LVFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     LVAnimatedImageView *imageView = [LVAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface LivelyFrameImage : UIImage <LVAnimatedImage>
...
/**
 ...
 @return An initialized LVFrameImage object, or nil when an error occurs.
 */
